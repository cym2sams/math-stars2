...
.screen { position: absolute; top: 0; padding: 20px; left: 0; width: 100%; height: 100%; display: none; flex-direction: column; justify-content: center; align-items: center; transition: opacity 0.4s ease-in-out; opacity: 0; }
...
.button-group {
    display: flex;
    justify-content: center; /* 讓剩餘的按鈕居中 */
    margin-top: 20px;
}
