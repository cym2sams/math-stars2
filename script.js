...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function main() {
        ...
        const ELEMENTS = {
            ...
            nextBtn: document.getElementById('next-btn'), startGameBtn: document.getElementById('start-game-btn'),
        ...
        const functions = {
            ...
            bindEvents() {
                ...
                // 在所有返回主選單的地方，強制隱藏 aidOverlay
                ELEMENTS.backToStartBtn.addEventListener('click', () => {
                    state.fullLeaderboard = null;
                    ELEMENTS.aidOverlay.classList.remove('active'); // 強制隱藏
                    functions.showScreen('start');
                });
